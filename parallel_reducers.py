...
# here we are creating the reducers to avoid the overriding
...
def copyright_node(state: AnalyzerState) -> dict:
    ...
    try:
     ...
     # Return a sub dictionary under our same state key 
...
def culture_node(state: AnalyzerState) -> dict:
    ...
    prompt = (
        ...
        "or cultural insensitivity that might offend a global audience. Provide a score from 0 to  "
